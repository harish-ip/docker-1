...
@Component({
  selector: 'app-open-site-admin-sent-items',
  templateUrl: './open-site-admin-sent-items.component.html',
  styleUrls: ['./open-site-admin-sent-items.component.css']
})
export class OpenSiteAdminSentItemsComponent implements OnInit {
  ...
  back() {
    this.router.navigate(['/siteadmin/notifications/site-admin-sent-items']);
  }
