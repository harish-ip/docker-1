...
@Component({
  selector: 'app-open-site-admin-notifications',
  templateUrl: './open-site-admin-notifications.component.html',
  styleUrls: ['./open-site-admin-notifications.component.css']
})
export class OpenSiteAdminNotificationsComponent implements OnInit {
  ...
  back() {
    this.router.navigate(['/siteadmin/notifications']);
  }
