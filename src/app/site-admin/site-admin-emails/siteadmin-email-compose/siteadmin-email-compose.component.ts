...
@Component({
  selector: 'app-siteadmin-email-compose',
  templateUrl: './siteadmin-email-compose.component.html',
  styleUrls: ['./siteadmin-email-compose.component.css']
})
export class SiteadminEmailComposeComponent implements OnInit, OnDestroy {
  ...
  deleteEmail() {
    ...
    if (this.indexval > -1) {
      ...
      if (this.selectedValue.length == 0) {
        this.clearFields();
        this.router.navigate(['siteadmin/emails/siteadmin-email-list']);
      }
    }
  }
